...
namespace projetIntegrateur.Controllers
{
    public class MembresController : Controller
    {
        ...
        public MembresController(bd_gestion_blocsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMembre,NomMembre,PrenomMembre,EmailMembre,MotPasseMembre,TelMembre")] Membre membre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMembre,NomMembre,PrenomMembre,EmailMembre,MotPasseMembre,TelMembre")] Membre membre)
        {
